        ...
        <>
            ...
            <form action="" className="space-y-2">
                ...
                <div className="flex items-center gap-10">
                    ...
                    <label htmlFor="dependent">Dependent Details</label>
                    
                    
                    <div className="space-x-2">
                    <label htmlFor="father">Father</label>
                    <input type="checkbox" name="dependent" id="father" />
                    </div>
                    
                   <div className="space-x-2">
                   <label htmlFor="father">Mother</label>
                   <input type="checkbox" name="dependent" id="father" />
                   </div>
                    <div className="space-x-2">
                    <label htmlFor="father">Wife</label>
                    <input type="checkbox" name="wife" id="wife" />
                    </div>
                    <div className="space-x-2">
                    <label htmlFor="children">Childrens</label>
                    <input type="number" className="px-2 py-1 w-[15%]"/>
                    </div>
