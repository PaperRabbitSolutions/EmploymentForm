...
const addAgreementSections = (doc, startY) => {
  const sections = [
    {
      title: "",
      content: "Employee Agreement to Comply with Anti-Bribery Regulations",
    },
    {
      title: "1. Purpose:",
      content:
    ...
    },
    {
      ...
      content:
        "PaperRabbit Solutions Pvt. Ltd. is committed to conducting business ethically and lawfully. The company strictly prohibits bribery and corruption in any form. " +
    ...
    },
    {
      ...
      content:
        "Bribery is the offering, giving, receiving, or soliciting of any valuable item to influence the actions of an official or any person in charge of a public or legal duty.",
    },
    {
      title: "4. Employee Obligations:",
      content:
        "• Employees shall not engage in bribery directly or through a third party.\n" +
    ...
    },
    {
      ...
      content:
        "The Company strictly prohibits facilitation payments or 'grease payments' intended to expedite or secure the performance of a routine governmental action.",
    },
    {
      title: "7. Compliance and Training:",
      content:
        "• Employees must undergo regular training on anti-bribery and anti-corruption laws and policies.\n" +
    ...
    },
    {
      title: "9. Declaration:",
      content:
        "I confirm that I have read, understood, and agree to comply with the above terms regarding anti-bribery regulations.",
    },
    {
      title: "", // **Adding space for signatures**
      content: "\n\n\n", // **10 blank lines before the signature**
    },
    {
      title:
  ...
  sections.forEach((section) => {
    ...
    if (section.title) {
      doc.setFont("helvetica", "bold");
      doc.setFontSize(12); // **Increased font size for subheadings**
